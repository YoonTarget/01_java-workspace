...
public class SetRun {
	...
	public static void main(String[] args) {
		...
		System.out.println(hs1); // 저장 순서 유지 안됨!! (인덱스 개념이 없음), 중복된 데이터(동일객체) 보관 불가능
