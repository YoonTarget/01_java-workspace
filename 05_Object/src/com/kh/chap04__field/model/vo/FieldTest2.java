package com.kh.chap04__field.model.vo;
...
public class FieldTest2 { // 클래스 시작
	 ...
	 * protected	=> 같은 패키지는 접근 가능, 다른 패키지일 경우 상속구조(부모자식간의 관계)에서는 접근 가능 => 나중에
	 * default		=> 같은 패키지에서만 접근 가능 (다른 패키지일 경우에는 절대 불가)
	...
	String def = "default"; // 안 쓰면 default
