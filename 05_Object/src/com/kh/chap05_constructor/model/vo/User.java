...
public class User {
	 ...
	 * 
	 * * 생성자 작성시 주의사항
	 * 1. 반드시 생성자명은 클래스명과 동일해야됨(대/소문자 구분) => 안 그러면 오류 남
	...
	public User(String userId, String userPwd, String userName, int age, char gender) {
		...
		*/
		 ...
		 * this() 생성자 활용 가능
		 * => 같은 클래스 내의 생성자에서 또 다른 생성자를 호출하고자 할 때 사용함.
		 * ** 유의사항 : 반드시 첫 줄에 작성해야됨!! 위치가 맨 위여야만 함. 아래에 있으면 에러 발생!!
		 */
