...
public class AbstrationRun {
	 ...
	 * 	  : 클래스라는 틀을 먼저 만들어야 됨!! (클래스란? 각 객체들의 속성(정보)들을 담아낼 그릇 같은 존재) => 이름, 나이, 주소, 휴대폰 번호 등등을 담을 수 있는 그릇
	 ...
	 * 
	 * 	  ex) 학생 관리 프로그램
	 *		1) 학생관련 객체 (문동은 학생, 박연진 학생, 이사라 학생, ...)
	 *		2) 공통적인 속성 및 기능들 (이름, 나이, 주소, 전화번호, 키, 몸무게, 달리기 속도, 학년, 반, 국어점수, 영어점수, 머리색깔, 발사이즈, 밥 먹는다, 잠잔다)
	 *		3) 학생 "인적사항"을 관리하는 프로그램이라고 한다면 : 이름, 나이, 주소, 전화번호, 학년, 반
	 *			학생 "성적"을 관리하는 프로그램이라고 한다면 : 이름, 학년, 반, 국어점수, 영어점수
	 ...
	 * 			이사라라는 학생 객체를 하나 만들어내기 위해서?? => String name3 = "이사라"; int age3 = 22; double height3 = 154.6;
	 ...
	 *			학생들의 키를 보관하는 double[] height = {160.1, 170.1, 150.1,...};
	 *
	 *			어떤 문제가 발생??
	 *			=> 기존의 학생 정보를 지워야 할 때 뒤의 정보들을 앞으로 땡기는 과정을 진행해야 함..
	 *			잘못 땡기면 정보가 틀어진다..
	 *
	 *			=> 새로운 학생이 전학 오면?? 배열을 다시 만들어야 함 + 복사해야함
	 *
	 *		3) 그래서 나온 개념이 구조체!!
	 *
	...
	public static void main(String[] args) {
		...
		// 자바에서의 객체로 만들기 위해서 new라는 키워드를 통해 Heap 영역에 생성 먼저 해야됨!! (공간할당)
		Student moon = new Student(); // 팥 붕어빵
		// 클래스명 별칭 = new 클래스명();
		...
		System.out.println(moon.name + " 님의 나이는 " + moon.age + "살이고, 키는 " + moon.height + "cm입니다.");

		
		// 박연진 학생 객체 만들기 => 박연진, 21, 173.4
		Student park = new Student(); // 슈크림 붕어빵
