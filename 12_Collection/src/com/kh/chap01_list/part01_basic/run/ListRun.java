...
public class ListRun {
	 ...
	 * 
	 * 		2. 배열 중간 위치에 값을 추가한다거나 삭제하는 경우 매번 값을 땡겨주는 복잡한 알고리즘을 직접 기술해야됨... 
	 * 
	 * 		3. 한 공간에 한 타입의 데이터만 저장 가능하다.
	 * 
	 * > 컬렉션의 장점
	 * 		1. 크기를 지정해줄 필요 없음!! 만일, 지정했다고 하더라도 더 많은 데이터들이 들어오면 알아서 사이즈를 늘려줌
	 * 		   크기에 제약이 없음
	 * 
	...
	public static void main(String[] args) {
		...
		ArrayList list = new ArrayList(3); // 크기 지정을 할 수도 있고, 안 할 수도 있음!! 안 하면 기본 크기 10으로 생성
		...
		// 지정된 크기보다 더 많이 넣어도 오류 안 남		=> 장점 1 : 크기에 제약이 없다
		// 다양한 타입의 데이터를 담을 수 있음			=> 장점 3 : 여러타입 보관 가능
		
		System.out.println(list); // list 특징 : 순서 유지하면서 담김 (0번 인덱스부터 차곡차곡)
		...
		// 8. addAll(Collection c) : 컬렉션 통째로 뒤에 추가시켜주는 메소드
		list.addAll(sub);
		System.out.println(list);
