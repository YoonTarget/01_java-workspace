...
public class InetRun {
	...
	public static void main(String[] args) {
		...
		/*
		 * * 네트워크(Network) : 여러대의 컴퓨터들이 연결되어 있는 통신망 같은 것
		 * 						=> 이런 네크워크를 통해 서로 간의 데이터 교환 가능!!
		 * 
		...
		try {
			...
			System.out.println("네이버 서버명 : " + naverHost.getHostName());
			System.out.println("네이버 IP주소 : " + naverHost.getHostAddress());
			*/
		 ...
		 * 	   이때 데이터를 입출력 하고자 한다면 서버와 클라이언트 간의 스트림(연결통로)이 필요함!!
		 * 
		 ...
		 * 		- UDP 방식 : 데이터 전송속도가 빠름!! 신뢰성 없는 데이터가 전달 될 수도 있음!! (데이터를 빠른 속도로 전송하고자 하는 프로그램 : 실시간 동영상 서비스)
		 */
